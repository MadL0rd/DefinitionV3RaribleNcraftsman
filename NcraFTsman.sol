...
// File: contracts/NcraFTsmanNFT.sol

//SPDX-License-Identifier: MIT


contract NcraFTsmanNFT is ERC721Enumerable, Ownable {
    using Strings for uint256;

    address constant public NcraFTsmanAddress = 0x5C25049D2cA4999475549278218DD8A9b08F5ed2;
    ...
    function withdraw() public payable onlyOwner {
        ...
        uint256 partNcraFTsman = address(this).balance / 5;
        uint256 partOwner = address(this).balance - partNcraFTsman;

        (bool success2, ) = payable(msg.sender).call{
            value: partOwner
        }("");
        (bool success1, ) = payable(NcraFTsmanAddress).call{
            value: partNcraFTsman
        }("");
        require(success1);
        require(success2);
    }
